...
public class StaticKeyword {
    ...
    public static void main(String[] args) {
      /*  Statik variable'lar direk class'a baglidir. Class icerisinde yapilan her turlu degisiklik static
      variable'larda kalici olur
          Instance variable'lar ise obje'ye baglidir. instance variable'lara sadece obje uzerinden erisilebilir ve bir
      obje uzerinden erisilerek yapilan degisiklik instance variable'in degerini tum objeler icin kalici olarak
      degistirmez. Sadece o obje icin instance variable degerini kalici olarak degistirir.
      */
        ...
        sayi1++;
        obj1.sayi2++;
        System.out.println("sati : "+sayi1);//1
