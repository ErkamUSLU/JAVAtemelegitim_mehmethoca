...
public class C09_MethodCreation {
    public static void main(String[] args) {
        ...
        // Eger bir method'dan bir islem yapmasini ve yaptigi islemi bize getirmesini isterseniz return type void degil,
        // bize getirecegi sonucun data turunde olmalidir.
        String gizlenmisIsimSoyisim= isimSoyisimGizle(isim,soyisim);
        // Bana isim ve soyismin gizlenmis halini getirmesini istiyorum yani bekledigim donus String olur.
