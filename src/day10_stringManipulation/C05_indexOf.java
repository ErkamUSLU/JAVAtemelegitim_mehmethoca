...
public class C05_indexOf {
    public static void main(String[] args) {
        ...
        System.out.println(str1.indexOf('g', 8));
        ...
        //y yok demesi lazim ama return type'i index yok demenin sayisal karsiligi olarak java -1 dondurmeyi tercih
        //etmistir.

        //Kullanicidan mail adresini isteyin. @ isareti icermiyorsa "gecersiz" yazdirin;iceriyorsa "mailiniz kabul
        //edildi" yazdırın.
        ...
        //OZET : indexOf method'u icierise yazilan String veya char'in metinde hangi index'de oldugu bize dondurur. Eger
        //aradıgımız metin veya char yoksa, olmadıgının delili olarak bize -1 dondurur.
    }
}
